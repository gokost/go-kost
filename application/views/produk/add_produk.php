          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              <div class="box-header">
                ...
                <h3 class="box-title">FORM TAMBAH DATA KOST</h3>
              </div>
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label for="">Harga</label>
                        <input type="text" class="form-control" value="" id="" name="harga" placeholder="Harga Perbulan" required>                        
                    </div>
                    <div class="form-group">
                      <label for="">Jumlah</label>
                        <input type="text" class="form-control" value="" id="" name="jumlah" placeholder="Jumlah Kamar" required>                        
                    </div>
                    <div class="form-group">
                      <label for="">Kondisi</label>
                        <input type="text" class="form-control" value="" id="" name="kondisi" placeholder="Kondisi Kamar" required>                        
                    </div>
