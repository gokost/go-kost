          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              <div class="box-header">
                ...
                <h3 class="box-title">FORM EDIT DATA KOST</h3>
              </div>
                    ...
                    <div class="form-group">
                      <label for="">lokasi</label>
                        <select name="id_lokasi" class="form-control" required>
                          <?php foreach($lokasi as $kat){
                            if(!in_array($kat['id_lokasi'],$lokasi_post)){
                              ?>
                              <option value="<?php echo $kat['id_lokasi'] ?>"><?php echo $kat['lokasi'] ?></option>
                              <?php } else { ?>
                              <option selected="selected" value="<?php echo $kat['id_lokasi'] ?>"><?php echo $kat['lokasi'] ?></option>
                              <?php } } ?>
                        </select>                        
                    </div>
