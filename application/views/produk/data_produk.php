    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-12">
            <a style="margin-bottom:3px" href="<?php echo base_url(); ?>produk/addproduk" class="btn btn-primary no-radius dropdown-toggle"><i class="fa fa-plus"></i> TAMBAH DATA KOST </a>
              <div class="box">
